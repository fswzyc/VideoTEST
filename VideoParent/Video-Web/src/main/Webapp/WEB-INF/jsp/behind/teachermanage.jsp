...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <button type="button" class="btn btn-info"><a href="${pageContext.request.contextPath}/addSpeaker">添加</a></button>
        </div>
...
<div class="container" style="margin-top:20px">
    <table class="table table-striped table-bordered table-hover" style="text-align:center; table-layout: fixed;">
        ...
        <tr>
            ...
            <th style="text-align:center; width: 16%;">职位</th>
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        <p:page url="${pageContext.request.contextPath}/teachermanage"></p:page>
    </div>
</div>
